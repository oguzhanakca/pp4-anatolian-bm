...
1.	As a User, I want to make a reservation online so that I can ensure a table is available when I visit.
2.	As a User, I can find social accounts of business so that I can visit their accounts.
3.	As a User, I can find a contact us page so that users can get in touch with business.
4.	As a User, I can view the opening hours and contact details so that I know when the business is open and how to contact them via phone and socials.
5.	As a User, I can book a table selecting a date and time so that I can reserve my table.
6.	As a User, I can add additional informations to my booking so that business can be prepared better.
7.  As a User, I can list my bookings so that I can see when did i book last time.
8. As a User, I can get informed when my booking status changed so that I know if its cancelled or not.
9. As a User, I can make an account so that I can use all the features.
10. As a User, I can login so that I can book a table.
11. As a User, I can reset my password once i forget.
12. As a User, I can view the site's blog so that I can learn additional information and read articles.
13. As a User, I can post on blog.
14. As a User, I can edit or delete my post.
15. As a User, I can comment on posts.

### Admin
16.	As an Admin, I can log in so that I can access the back end of the site.
17.	As an Admin, I can add and remove products.
18. As an Admin, I can accept or reject bookings so that I can avoid double bookings.
19. As an Admin, I can add,read, update and remove posts.
20. As an Admin, I can add,read, update and remove comments.

### Site Owner  
21. As a Site Owner, I can provide a fully responsive site for my customers so that they have a good user experience.
22. As a Site Owner, I can validate data entered into my site so that all submitted data is correct to avoid errors.
23. As a Site Owner, I can provide information about my business.
